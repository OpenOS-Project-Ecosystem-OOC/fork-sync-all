...
> Auto-generated on 2026-06-16 from `config/gitlab-subgroups.yml`.
...
| Repo | GitHub | GitLab |
|---|---|---|
| `gha-repo-manager` | [GitHub](https://github.com/OpenOS-Project-OSP/gha-repo-manager) | [GitLab](https://gitlab.com/openos-project/git-management_deving/gha-repo-manager) |
| `git-release-shell` | [GitHub](https://github.com/OpenOS-Project-OSP/git-release-shell) | [GitLab](https://gitlab.com/openos-project/git-management_deving/git-release-shell) |
| `git-repo-manager` | [GitHub](https://github.com/OpenOS-Project-OSP/git-repo-manager) | [GitLab](https://gitlab.com/openos-project/git-management_deving/git-repo-manager) |
| `git-repo-worktrees-manager` | [GitHub](https://github.com/OpenOS-Project-OSP/git-repo-worktrees-manager) | [GitLab](https://gitlab.com/openos-project/git-management_deving/git-repo-worktrees-manager) |
| `github-api-scripts` | [GitHub](https://github.com/OpenOS-Project-OSP/github-api-scripts) | [GitLab](https://gitlab.com/openos-project/git-management_deving/github-api-scripts) |
| `github-api-scripts1` | [GitHub](https://github.com/OpenOS-Project-OSP/github-api-scripts1) | [GitLab](https://gitlab.com/openos-project/git-management_deving/github-api-scripts1) |
...
| Repo | GitHub | GitLab |
|---|---|---|
| `Image-Server` | [GitHub](https://github.com/OpenOS-Project-OSP/Image-Server) | [GitLab](https://gitlab.com/openos-project/incus_deving/Image-Server) |
| `Incus-MacOS-Toolkit` | [GitHub](https://github.com/OpenOS-Project-OSP/Incus-MacOS-Toolkit) | [GitLab](https://gitlab.com/openos-project/incus_deving/Incus-MacOS-Toolkit) |
| `K8s-in-incus` | [GitHub](https://github.com/OpenOS-Project-OSP/K8s-in-incus) | [GitLab](https://gitlab.com/openos-project/incus_deving/K8s-in-incus) |
| `LXD-Manager` | [GitHub](https://github.com/OpenOS-Project-OSP/LXD-Manager) | [GitLab](https://gitlab.com/openos-project/incus_deving/LXD-Manager) |
| `blincus` | [GitHub](https://github.com/OpenOS-Project-OSP/blincus) | [GitLab](https://gitlab.com/openos-project/incus_deving/blincus) |
| `cluster-api-provider-incus` | [GitHub](https://github.com/OpenOS-Project-OSP/cluster-api-provider-incus) | [GitLab](https://gitlab.com/openos-project/incus_deving/cluster-api-provider-incus) |
| `ctde` | [GitHub](https://github.com/OpenOS-Project-OSP/ctde) | [GitLab](https://gitlab.com/openos-project/incus_deving/ctde) |
| `distrobuilder` | [GitHub](https://github.com/OpenOS-Project-OSP/distrobuilder) | [GitLab](https://gitlab.com/openos-project/incus_deving/distrobuilder) |
| `dotdrop` | [GitHub](https://github.com/OpenOS-Project-OSP/dotdrop) | [GitLab](https://gitlab.com/openos-project/incus_deving/dotdrop) |
| `ezpodman-sandbox` | [GitHub](https://github.com/OpenOS-Project-OSP/ezpodman-sandbox) | [GitLab](https://gitlab.com/openos-project/incus_deving/ezpodman-sandbox) |
| `gh-actions-manager` | [GitHub](https://github.com/OpenOS-Project-OSP/gh-actions-manager) | [GitLab](https://gitlab.com/openos-project/incus_deving/gh-actions-manager) |
| `incus` | [GitHub](https://github.com/OpenOS-Project-OSP/incus) | [GitLab](https://gitlab.com/openos-project/incus_deving/incus) |
| `incus-agent-sysvinit` | [GitHub](https://github.com/OpenOS-Project-OSP/incus-agent-sysvinit) | [GitLab](https://gitlab.com/openos-project/incus_deving/incus-agent-sysvinit) |
| `incus-app-container` | [GitHub](https://github.com/OpenOS-Project-OSP/incus-app-container) | [GitLab](https://gitlab.com/openos-project/incus_deving/incus-app-container) |
| `incus-cloud-init` | [GitHub](https://github.com/OpenOS-Project-OSP/incus-cloud-init) | [GitLab](https://gitlab.com/openos-project/incus_deving/incus-cloud-init) |
| `incus-compose` | [GitHub](https://github.com/OpenOS-Project-OSP/incus-compose) | [GitLab](https://gitlab.com/openos-project/incus_deving/incus-compose) |
| `incus-demo-server` | [GitHub](https://github.com/OpenOS-Project-OSP/incus-demo-server) | [GitLab](https://gitlab.com/openos-project/incus_deving/incus-demo-server) |
| `incus-deploy` | [GitHub](https://github.com/OpenOS-Project-OSP/incus-deploy) | [GitLab](https://gitlab.com/openos-project/incus_deving/incus-deploy) |
| `incus-docker` | [GitHub](https://github.com/OpenOS-Project-OSP/incus-docker) | [GitLab](https://gitlab.com/openos-project/incus_deving/incus-docker) |
| `incus-gha` | [GitHub](https://github.com/OpenOS-Project-OSP/incus-gha) | [GitLab](https://gitlab.com/openos-project/incus_deving/incus-gha) |
| `incus-goad` | [GitHub](https://github.com/OpenOS-Project-OSP/incus-goad) | [GitLab](https://gitlab.com/openos-project/incus_deving/incus-goad) |
| `incus-image-server` | [GitHub](https://github.com/OpenOS-Project-OSP/incus-image-server) | [GitLab](https://gitlab.com/openos-project/incus_deving/incus-image-server) |
| `incus-images` | [GitHub](https://github.com/OpenOS-Project-OSP/incus-images) | [GitLab](https://gitlab.com/openos-project/incus_deving/incus-images) |
| `incus-init-scripts` | [GitHub](https://github.com/OpenOS-Project-OSP/incus-init-scripts) | [GitLab](https://gitlab.com/openos-project/incus_deving/incus-init-scripts) |
| `incus-launch-vm-action` | [GitHub](https://github.com/OpenOS-Project-OSP/incus-launch-vm-action) | [GitLab](https://gitlab.com/openos-project/incus_deving/incus-launch-vm-action) |
| `incus-linux-toolkit` | [GitHub](https://github.com/OpenOS-Project-OSP/incus-linux-toolkit) | [GitLab](https://gitlab.com/openos-project/incus_deving/incus-linux-toolkit) |
| `incus-os` | [GitHub](https://github.com/OpenOS-Project-OSP/incus-os) | [GitLab](https://gitlab.com/openos-project/incus_deving/incus-os) |
| `incus-package-repo` | [GitHub](https://github.com/OpenOS-Project-OSP/incus-package-repo) | [GitLab](https://gitlab.com/openos-project/incus_deving/incus-package-repo) |
| `incus-sdk` | [GitHub](https://github.com/OpenOS-Project-OSP/incus-sdk) | [GitLab](https://gitlab.com/openos-project/incus_deving/incus-sdk) |
| `incus-ui-canonical` | [GitHub](https://github.com/OpenOS-Project-OSP/incus-ui-canonical) | [GitLab](https://gitlab.com/openos-project/incus_deving/incus-ui-canonical) |
| `incus-waydroid-toolkit` | [GitHub](https://github.com/OpenOS-Project-OSP/incus-waydroid-toolkit) | [GitLab](https://gitlab.com/openos-project/incus_deving/incus-waydroid-toolkit) |
| `incus-windows` | [GitHub](https://github.com/OpenOS-Project-OSP/incus-windows) | [GitLab](https://gitlab.com/openos-project/incus_deving/incus-windows) |
| `incus-windows-toolkit` | [GitHub](https://github.com/OpenOS-Project-OSP/incus-windows-toolkit) | [GitLab](https://gitlab.com/openos-project/incus_deving/incus-windows-toolkit) |
| `incus_container_gui_setup` | [GitHub](https://github.com/OpenOS-Project-OSP/incus_container_gui_setup) | [GitLab](https://gitlab.com/openos-project/incus_deving/incus_container_gui_setup) |
| `incus_container_manager` | [GitHub](https://github.com/OpenOS-Project-OSP/incus_container_manager) | [GitLab](https://gitlab.com/openos-project/incus_deving/incus_container_manager) |
| `incuslab` | [GitHub](https://github.com/OpenOS-Project-OSP/incuslab) | [GitLab](https://gitlab.com/openos-project/incus_deving/incuslab) |
| `infra-dashboard` | [GitHub](https://github.com/OpenOS-Project-OSP/infra-dashboard) | [GitLab](https://gitlab.com/openos-project/incus_deving/infra-dashboard) |
| `kapsule` | [GitHub](https://github.com/OpenOS-Project-OSP/kapsule) | [GitLab](https://gitlab.com/openos-project/incus_deving/kapsule) |
| `kapsule-incus-manager` | [GitHub](https://github.com/OpenOS-Project-OSP/kapsule-incus-manager) | [GitLab](https://gitlab.com/openos-project/incus_deving/kapsule-incus-manager) |
| `lxd_incus_gui_apps` | [GitHub](https://github.com/OpenOS-Project-OSP/lxd_incus_gui_apps) | [GitLab](https://gitlab.com/openos-project/incus_deving/lxd_incus_gui_apps) |
| `packer-plugin-incus` | [GitHub](https://github.com/OpenOS-Project-OSP/packer-plugin-incus) | [GitLab](https://gitlab.com/openos-project/incus_deving/packer-plugin-incus) |
| `packer-plugin-incuschroot` | [GitHub](https://github.com/OpenOS-Project-OSP/packer-plugin-incuschroot) | [GitLab](https://gitlab.com/openos-project/incus_deving/packer-plugin-incuschroot) |
| `podclaw` | [GitHub](https://github.com/OpenOS-Project-OSP/podclaw) | [GitLab](https://gitlab.com/openos-project/incus_deving/podclaw) |
| `polar` | [GitHub](https://github.com/OpenOS-Project-OSP/polar) | [GitLab](https://gitlab.com/openos-project/incus_deving/polar) |
| `setup-incus` | [GitHub](https://github.com/OpenOS-Project-OSP/setup-incus) | [GitLab](https://gitlab.com/openos-project/incus_deving/setup-incus) |
| `talos` | [GitHub](https://github.com/OpenOS-Project-OSP/talos) | [GitLab](https://gitlab.com/openos-project/incus_deving/talos) |
| `talos-incus` | [GitHub](https://github.com/OpenOS-Project-OSP/talos-incus) | [GitLab](https://gitlab.com/openos-project/incus_deving/talos-incus) |
...
| `qt-kde-team.pages.debian.net` | [GitHub](https://github.com/OpenOS-Project-OSP/qt-kde-team.pages.debian.net) | [GitLab](https://gitlab.com/openos-project/neon-deving/qt-kde-team.pages.debian.net) |
| `ubuntu-core` | [GitHub](https://github.com/OpenOS-Project-OSP/ubuntu-core) | [GitLab](https://gitlab.com/openos-project/neon-deving/ubuntu-core) |

## [ops](https://gitlab.com/openos-project/ops)
...
| `bash-api-server` | [GitHub](https://github.com/OpenOS-Project-OSP/bash-api-server) | [GitLab](https://gitlab.com/openos-project/ops/bash-api-server) |
| `bash-it` | [GitHub](https://github.com/OpenOS-Project-OSP/bash-it) | [GitLab](https://gitlab.com/openos-project/ops/bash-it) |
| `bashly` | [GitHub](https://github.com/OpenOS-Project-OSP/bashly) | [GitLab](https://gitlab.com/openos-project/ops/bashly) |
| `build-server` | [GitHub](https://github.com/OpenOS-Project-OSP/build-server) | [GitLab](https://gitlab.com/openos-project/ops/build-server) |
| `flatpak-repo` | [GitHub](https://github.com/OpenOS-Project-OSP/flatpak-repo) | [GitLab](https://gitlab.com/openos-project/ops/flatpak-repo) |
| `fork-sync-all` | [GitHub](https://github.com/OpenOS-Project-OSP/fork-sync-all) | [GitLab](https://gitlab.com/openos-project/ops/fork-sync-all) |
| `git-sizer` | [GitHub](https://github.com/OpenOS-Project-OSP/git-sizer) | [GitLab](https://gitlab.com/openos-project/ops/git-sizer) |
| `github-exporter` | [GitHub](https://github.com/OpenOS-Project-OSP/github-exporter) | [GitLab](https://gitlab.com/openos-project/ops/github-exporter) |
| `headroom` | [GitHub](https://github.com/OpenOS-Project-OSP/headroom) | [GitLab](https://gitlab.com/openos-project/ops/headroom) |
| `hrsync` | [GitHub](https://github.com/OpenOS-Project-OSP/hrsync) | [GitLab](https://gitlab.com/openos-project/ops/hrsync) |
| `ipinfo` | [GitHub](https://github.com/OpenOS-Project-OSP/ipinfo) | [GitLab](https://gitlab.com/openos-project/ops/ipinfo) |
| `linux-shell-script-archive` | [GitHub](https://github.com/OpenOS-Project-OSP/linux-shell-script-archive) | [GitLab](https://gitlab.com/openos-project/ops/linux-shell-script-archive) |
| `lowlighter-metrics` | [GitHub](https://github.com/OpenOS-Project-OSP/lowlighter-metrics) | [GitLab](https://gitlab.com/openos-project/ops/lowlighter-metrics) |
| `mass_clone` | [GitHub](https://github.com/OpenOS-Project-OSP/mass_clone) | [GitLab](https://gitlab.com/openos-project/ops/mass_clone) |
| `namefix` | [GitHub](https://github.com/OpenOS-Project-OSP/namefix) | [GitLab](https://gitlab.com/openos-project/ops/namefix) |
| `operation-phantom-shell` | [GitHub](https://github.com/OpenOS-Project-OSP/operation-phantom-shell) | [GitLab](https://gitlab.com/openos-project/ops/operation-phantom-shell) |
| `org-mirror` | [GitHub](https://github.com/OpenOS-Project-OSP/org-mirror) | [GitLab](https://gitlab.com/openos-project/ops/org-mirror) |
| `remote-sync` | [GitHub](https://github.com/OpenOS-Project-OSP/remote-sync) | [GitLab](https://gitlab.com/openos-project/ops/remote-sync) |
| `rtk` | [GitHub](https://github.com/OpenOS-Project-OSP/rtk) | [GitLab](https://gitlab.com/openos-project/ops/rtk) |
| `shell2http` | [GitHub](https://github.com/OpenOS-Project-OSP/shell2http) | [GitLab](https://gitlab.com/openos-project/ops/shell2http) |
| `shellqueue` | [GitHub](https://github.com/OpenOS-Project-OSP/shellqueue) | [GitLab](https://gitlab.com/openos-project/ops/shellqueue) |
| `simple-deploy` | [GitHub](https://github.com/OpenOS-Project-OSP/simple-deploy) | [GitLab](https://gitlab.com/openos-project/ops/simple-deploy) |
| `smartcd` | [GitHub](https://github.com/OpenOS-Project-OSP/smartcd) | [GitLab](https://gitlab.com/openos-project/ops/smartcd) |
| `unified-agnostic-api` | [GitHub](https://github.com/OpenOS-Project-OSP/unified-agnostic-api) | [GitLab](https://gitlab.com/openos-project/ops/unified-agnostic-api) |
| `utility_shell` | [GitHub](https://github.com/OpenOS-Project-OSP/utility_shell) | [GitLab](https://gitlab.com/openos-project/ops/utility_shell) |
...
| Repo | GitHub | GitLab |
|---|---|---|
| `CI-Debugger` | [GitHub](https://github.com/OpenOS-Project-OSP/CI-Debugger) | [GitLab](https://gitlab.com/openos-project/yaml-tooling_deving/CI-Debugger) |
| `actions-orchestrator` | [GitHub](https://github.com/OpenOS-Project-OSP/actions-orchestrator) | [GitLab](https://gitlab.com/openos-project/yaml-tooling_deving/actions-orchestrator) |
| `activitysmith-github-action` | [GitHub](https://github.com/OpenOS-Project-OSP/activitysmith-github-action) | [GitLab](https://gitlab.com/openos-project/yaml-tooling_deving/activitysmith-github-action) |
| `agentshield` | [GitHub](https://github.com/OpenOS-Project-OSP/agentshield) | [GitLab](https://gitlab.com/openos-project/yaml-tooling_deving/agentshield) |
| `blueprint` | [GitHub](https://github.com/OpenOS-Project-OSP/blueprint) | [GitLab](https://gitlab.com/openos-project/yaml-tooling_deving/blueprint) |
| `confmgr` | [GitHub](https://github.com/OpenOS-Project-OSP/confmgr) | [GitLab](https://gitlab.com/openos-project/yaml-tooling_deving/confmgr) |
| `deardir` | [GitHub](https://github.com/OpenOS-Project-OSP/deardir) | [GitLab](https://gitlab.com/openos-project/yaml-tooling_deving/deardir) |
| `denoflow` | [GitHub](https://github.com/OpenOS-Project-OSP/denoflow) | [GitLab](https://gitlab.com/openos-project/yaml-tooling_deving/denoflow) |
| `directory-model` | [GitHub](https://github.com/OpenOS-Project-OSP/directory-model) | [GitLab](https://gitlab.com/openos-project/yaml-tooling_deving/directory-model) |
| `dirstructx` | [GitHub](https://github.com/OpenOS-Project-OSP/dirstructx) | [GitLab](https://gitlab.com/openos-project/yaml-tooling_deving/dirstructx) |
| `fluent-github-actions` | [GitHub](https://github.com/OpenOS-Project-OSP/fluent-github-actions) | [GitLab](https://gitlab.com/openos-project/yaml-tooling_deving/fluent-github-actions) |
| `gavi` | [GitHub](https://github.com/OpenOS-Project-OSP/gavi) | [GitLab](https://gitlab.com/openos-project/yaml-tooling_deving/gavi) |
| `git-queue` | [GitHub](https://github.com/OpenOS-Project-OSP/git-queue) | [GitLab](https://gitlab.com/openos-project/yaml-tooling_deving/git-queue) |
| `github-actions-virtualization-support` | [GitHub](https://github.com/OpenOS-Project-OSP/github-actions-virtualization-support) | [GitLab](https://gitlab.com/openos-project/yaml-tooling_deving/github-actions-virtualization-support) |
| `github-actions-workflow-ts` | [GitHub](https://github.com/OpenOS-Project-OSP/github-actions-workflow-ts) | [GitLab](https://gitlab.com/openos-project/yaml-tooling_deving/github-actions-workflow-ts) |
| `graphize` | [GitHub](https://github.com/OpenOS-Project-OSP/graphize) | [GitLab](https://gitlab.com/openos-project/yaml-tooling_deving/graphize) |
| `katachi` | [GitHub](https://github.com/OpenOS-Project-OSP/katachi) | [GitLab](https://gitlab.com/openos-project/yaml-tooling_deving/katachi) |
| `llm-docs-generator` | [GitHub](https://github.com/OpenOS-Project-OSP/llm-docs-generator) | [GitLab](https://gitlab.com/openos-project/yaml-tooling_deving/llm-docs-generator) |
| `matrix-lock` | [GitHub](https://github.com/OpenOS-Project-OSP/matrix-lock) | [GitLab](https://gitlab.com/openos-project/yaml-tooling_deving/matrix-lock) |
| `mnemonic` | [GitHub](https://github.com/OpenOS-Project-OSP/mnemonic) | [GitLab](https://gitlab.com/openos-project/yaml-tooling_deving/mnemonic) |
| `models-generator` | [GitHub](https://github.com/OpenOS-Project-OSP/models-generator) | [GitLab](https://gitlab.com/openos-project/yaml-tooling_deving/models-generator) |
| `pkgbuild-action` | [GitHub](https://github.com/OpenOS-Project-OSP/pkgbuild-action) | [GitLab](https://gitlab.com/openos-project/yaml-tooling_deving/pkgbuild-action) |
| `project-memory-mcp` | [GitHub](https://github.com/OpenOS-Project-OSP/project-memory-mcp) | [GitLab](https://gitlab.com/openos-project/yaml-tooling_deving/project-memory-mcp) |
| `pyvert` | [GitHub](https://github.com/OpenOS-Project-OSP/pyvert) | [GitLab](https://gitlab.com/openos-project/yaml-tooling_deving/pyvert) |
| `scriptfs` | [GitHub](https://github.com/OpenOS-Project-OSP/scriptfs) | [GitLab](https://gitlab.com/openos-project/yaml-tooling_deving/scriptfs) |
| `super-yaml` | [GitHub](https://github.com/OpenOS-Project-OSP/super-yaml) | [GitLab](https://gitlab.com/openos-project/yaml-tooling_deving/super-yaml) |
| `system-cleanup-manager` | [GitHub](https://github.com/OpenOS-Project-OSP/system-cleanup-manager) | [GitLab](https://gitlab.com/openos-project/yaml-tooling_deving/system-cleanup-manager) |
| `velite` | [GitHub](https://github.com/OpenOS-Project-OSP/velite) | [GitLab](https://gitlab.com/openos-project/yaml-tooling_deving/velite) |
| `xml-yaml-json-converter` | [GitHub](https://github.com/OpenOS-Project-OSP/xml-yaml-json-converter) | [GitLab](https://gitlab.com/openos-project/yaml-tooling_deving/xml-yaml-json-converter) |
| `y2j` | [GitHub](https://github.com/OpenOS-Project-OSP/y2j) | [GitLab](https://gitlab.com/openos-project/yaml-tooling_deving/y2j) |
| `yaml-fuse` | [GitHub](https://github.com/OpenOS-Project-OSP/yaml-fuse) | [GitLab](https://gitlab.com/openos-project/yaml-tooling_deving/yaml-fuse) |
